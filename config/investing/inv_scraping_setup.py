...
def init(DIRS):
    ...
    USDBASE_AVAILABLE_PAIRS = [
        ('USD', 'JPY'), ('USD', 'CHF'), ('USD', 'CAD'), ('USD', 'ZAR'), ('USD', 'TRY'), ('USD', 'MXN'), ('USD', 'PLN'), ('USD', 'SEK'), 
        ('USD', 'SGD'), ('USD', 'DKK'), ('USD', 'NOK'), ('USD', 'ILS'), ('USD', 'HUF'), ('USD', 'CZK'), ('USD', 'THB'), ('USD', 'AED'), 
        ('USD', 'JOD'), ('USD', 'KWD'), ('USD', 'HKD'), ('USD', 'SAR'), ('USD', 'INR'), ('USD', 'KRW'), ('USD', 'AMD'), ('USD', 'ANG'), 
        ('USD', 'ARS'), ('USD', 'AUD'), ('USD', 'BBD'), ('USD', 'BDT'), ('USD', 'BGN'), ('USD', 'BHD'), ('USD', 'BIF'), ('USD', 'BND'), 
        ('USD', 'BOB'), ('USD', 'BRL'), ('USD', 'BSD'), ('USD', 'BWP'), ('USD', 'BZD'), ('USD', 'CLP'), ('USD', 'CNY'), ('USD', 'COP'), 
        ('USD', 'CRC'), ('USD', 'CUP'), ('USD', 'DJF'), ('USD', 'DOP'), ('USD', 'DZD'), ('USD', 'EGP'), ('USD', 'ETB'), ('USD', 'EUR'), 
        ('USD', 'FJD'), ('USD', 'GBP'), ('USD', 'GEL'), ('USD', 'GHS'), ('USD', 'GMD'), ('USD', 'GNF'), ('USD', 'GTQ'), ('USD', 'HNL'), 
        ('USD', 'HRK'), ('USD', 'HTG'), ('USD', 'IDR'), ('USD', 'IQD'), ('USD', 'IRR'), ('USD', 'ISK'), ('USD', 'JMD'), ('USD', 'KES'), 
        ('USD', 'KHR'), ('USD', 'KMF'), ('USD', 'KZT'), ('USD', 'LAK'), ('USD', 'LBP'), ('USD', 'LKR'), ('USD', 'LSL'), ('USD', 'LYD'), 
        ('USD', 'MAD'), ('USD', 'MDL'), ('USD', 'MGA'), ('USD', 'MKD'), ('USD', 'MMK'), ('USD', 'MOP'), ('USD', 'MRO'), ('USD', 'MUR'), 
        ('USD', 'MVR'), ('USD', 'MWK'), ('USD', 'MYR'), ('USD', 'NAD'), ('USD', 'NGN'), ('USD', 'NIO'), ('USD', 'NPR'), ('USD', 'NZD'), 
        ('USD', 'OMR'), ('USD', 'PAB'), ('USD', 'PEN'), ('USD', 'PGK'), ('USD', 'PHP'), ('USD', 'PKR'), ('USD', 'PYG'), ('USD', 'QAR'), 
        ('USD', 'RON'), ('USD', 'RSD'), ('USD', 'RUB'), ('USD', 'RWF'), ('USD', 'SCR'), ('USD', 'SDG'), ('USD', 'SOS'), ('USD', 'STD'), 
        ('USD', 'SVC'), ('USD', 'SYP'), ('USD', 'SZL'), ('USD', 'TND'), ('USD', 'TTD'), ('USD', 'TWD'), ('USD', 'TZS'), ('USD', 'UAH'), 
        ('USD', 'UGX'), ('USD', 'UYU'), ('USD', 'UZS'), ('USD', 'VND'), ('USD', 'VUV'), ('USD', 'XAF'), ('USD', 'XCD'), ('USD', 'XOF'), 
        ('USD', 'XPF'), ('USD', 'YER'), ('USD', 'ZMK'), ('USD', 'BYN'), ('USD', 'MZN'), ('USD', 'AZN'), ('USD', 'CNH'), ('USD', 'KGS'), 
        ('USD', 'TJS'), ('USD', 'AOA'), ('USD', 'TMT'), ('USD', 'BRLT'), ('USD', 'MNT'), ('USD', 'AFN'), ('USD', 'ZWL')
    ]
    ...
    return {
        ...
        "AVAILABLE_PAIRS":USDBASE_AVAILABLE_PAIRS
    }
