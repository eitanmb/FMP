...
def create_json_directory_structure(ROOT_JSON_DIR: str, subdirectories_list: list):
    ...
    path_dir_by_date = create_data_dir_path_by_date(ROOT_JSON_DIR, json_sudirs_by_date)
    make_directory(path_dir_by_date)
    create_data_subdirs_path_by_subject(path_dir_by_date, json_data_subdirs, json_financials_subdirs)
